...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 1497.0, 50.0, 49.0 ],
					"style" : "",
					"text" : "recall 12 12 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 103.5, 1290.5, 79.0, 22.0 ],
					"style" : "",
					"text" : "routepass int"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 103.5, 1477.0, 24.0, 22.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 103.5, 1525.0, 41.0, 22.0 ],
					"style" : "",
					"text" : "zl join"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.5, 1501.0, 111.0, 22.0 ],
					"style" : "",
					"text" : "recall 12 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 103.5, 1440.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "line 1. 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 103.5, 1393.0, 24.0, 22.0 ],
					"style" : "",
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.5, 1339.0, 87.0, 22.0 ],
					"style" : "",
					"text" : "prepend recall"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 103.5, 1315.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "zl stream 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.5, 1416.0, 67.0, 22.0 ],
					"style" : "",
					"text" : "0., 1. 1000"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 85.0, 276.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "done"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 115.0, 319.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "done"
								}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 596.0, 85.0, 100.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 700.0, 1329.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "+ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 7,
					"outlettype" : [ "", "", "", "", "", "", "" ],
					"patching_rect" : [ 596.0, 1287.0, 123.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 397.0, 272.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 103.5, 1564.0, 150.0, 22.0 ],
					"style" : "",
...
,
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 31.5, 1603.0, 110.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 397.0, 335.0, 95.0, 22.0 ],
					"style" : "",
					"text" : "o.prepend /floor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 397.0, 296.0, 86.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /preset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 596.0, 296.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /volume"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 144.5, 1603.0, 58.0, 22.0 ],
					"restore" : 					{
						"ema_floor_sim" : [ 2 ],
						"ema_floor_vis" : [ 15 ],
						"ema_scrim_sim" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 596.0, 248.0, 91.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 397.0, 226.0, 174.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 397.0, 248.0, 174.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-87", 0 ],
					"midpoints" : [ 113.0, 1587.0, 41.0, 1587.0 ],
					"source" : [ "obj-110", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 113.0, 1380.0, 205.0, 1380.0 ],
					"order" : 0,
					"source" : [ "obj-276", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-87", 0 ],
					"midpoints" : [ 113.0, 1548.0, 41.0, 1548.0 ],
					"source" : [ "obj-291", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-87", 0 ],
					"midpoints" : [ 173.0, 1314.0, 201.0, 1314.0, 201.0, 1380.0, 41.0, 1380.0 ],
					"source" : [ "obj-312", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-99", 0 ],
					"midpoints" : [ 41.0, 1637.0, 18.0, 1637.0, 18.0, 1182.0, 41.0, 1182.0 ],
					"order" : 1,
					"source" : [ "obj-87", 0 ]
				}
