...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 304.5, 153.5, 79.0, 33.0 ],
					"presentation_rect" : [ 322.0, 155.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "Macroscopic\ncurl"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 159.0, 63.0, 33.0 ],
					"style" : "",
					"text" : "Bounding box."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.5, 425.0, 139.0, 20.0 ],
					"style" : "",
					"text" : "((r.y - l.y) - (d.x - u.x)) / 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.055542, 464.0, 184.333374, 22.0 ],
					"style" : "",
					"text" : "expr (($f3 - $f2) - ($f4 - $f1)) / 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 399.5, 159.0, 117.0, 22.0 ],
					"presentation_rect" : [ 463.0, 163.0, 0.0, 0.0 ],
					"style" : "",
					"text" : "servername velocity"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.5, 191.0, 102.0, 22.0 ],
					"presentation_rect" : [ 448.0, 195.0, 0.0, 0.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 92.0, 159.0, 127.0, 22.0 ],
					"style" : "",
					"text" : "servername presence"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 77.0, 191.0, 102.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.syphonclient"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 384.5, 269.0, 209.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.texture @dim 160 120 @adapt 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 610.277771, 244.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 610.277771, 220.0, 39.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 423.055542, 503.0, 66.444458, 22.0 ],
					"style" : "",
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 533.277771, 425.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "zl mth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 478.166626, 425.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "zl mth 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 588.388916, 425.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "zl mth 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 423.055542, 425.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "zl mth 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 577.388916, 386.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 522.277771, 386.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 467.166626, 386.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 412.055542, 386.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "jit.3m"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.5, 347.0, 267.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 384.5, 308.0, 137.0, 22.0 ],
					"style" : "",
					"text" : "jit.matrix @dim 160 120"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 180.0, 109.0, 22.0 ],
									"style" : "",
									"text" : "vec 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 109.0, 141.0, 64.0, 22.0 ],
									"style" : "",
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 141.0, 64.0, 22.0 ],
									"style" : "",
									"text" : "+"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 109.0, 102.0, 29.0, 22.0 ],
									"style" : "",
									"text" : "* -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 102.0, 29.0, 22.0 ],
									"style" : "",
									"text" : "* -1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 109.0, 63.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "swiz z"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 64.0, 63.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "swiz y"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 63.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "swiz x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 19.0, 9.0, 30.0, 22.0 ],
									"style" : "",
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 19.0, 219.0, 37.0, 22.0 ],
									"style" : "",
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 384.5, 230.0, 105.0, 22.0 ],
					"style" : "",
					"text" : "jit.gl.pix @t tofloat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 613.0, 410.0, 22.0 ],
...
,
					"style" : "",
					"text" : "pattr @bindto velocity::syphon::cam_syphon_app @initial Max @invisible 1",
					"varname" : "u661352106"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 637.0, 419.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "Max" ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr @bindto presence::syphon::cam_syphon_app @initial Max @invisible 1",
					"varname" : "u975352108"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 565.0, 364.0, 22.0 ],
					"saved_object_attributes" : 					{
...
,
					"style" : "",
					"text" : "pattr @bindto velocity::texture @initial motion-velocity @invisible 1",
					"varname" : "u151352110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 589.0, 383.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "motion-presence" ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr @bindto presence::texture @initial motion-presence @invisible 1",
					"varname" : "u598352112"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 661.0, 441.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "velocity" ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr @bindto velocity::syphon::cam_syphon_server @initial velocity @invisible 1",
					"varname" : "u894352114"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 57.5, 685.0, 459.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "presence" ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr @bindto presence::syphon::cam_syphon_server @initial presence @invisible 1",
					"varname" : "u195352116"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.0, 120.0, 127.0, 22.0 ],
					"style" : "",
					"text" : "loadmess setapp Max"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 12.0, 9.0, 712.5, 20.0 ],
					"style" : "",
					"text" : "Clouds motion analysis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 279.0, 244.0, 80.0, 60.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 279.0, 220.0, 39.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 151.0, 31.0, 569.0, 47.0 ],
					"style" : "",
					"text" : "This is in a separate patch with its own jit.world to make sure it is executed in a separate thread from the clouds. Using a lower fps makes sure we aren't constantly transferring the obstacles texture out of video memory."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 79.0, 98.0, 22.0 ],
					"style" : "",
					"text" : "loadmess fps 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 31.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 77.0, 308.0, 76.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /ema"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 171.0, 269.0, 95.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 77.0, 269.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "o.pack /bounds"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 77.0, 347.0, 142.0, 22.0 ],
					"style" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 377.0, 65.0, 333.5, 60.0 ],
									"style" : "",
									"text" : "Alternate method computing on GPU.\nThis seems to slow it down a lot. Since most of the clouds are computed on the GPU, if we CAN use the CPU for anything, we may as well."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 166.0, 65.0, 209.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.texture @dim 160 120 @adapt 0"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													"code" : "// 0: min x, 1: max x, 2: min y, 3: max y\r\nc = norm * dim;\r\nminx = norm.x < 0.5 && norm.y < 0.5;  miny = norm.x >= 0.5 && norm.y < 0.5;\r\nmaxx = norm.x < 0.5 && norm.y >= 0.5; maxy = norm.x >= 0.5 && norm.y >= 0.5;\r\nhorz = minx || maxx; vert = miny || maxy;\r\niter = horz * dim.x + vert * dim.y;\r\ni = 0; coord = -1;\r\n\r\nwhile (i < iter) {\r\n\tx = horz * (minx * (i / dim.x) + maxx * ((dim.x - i) / dim.x)) + (1 - horz) * norm.x;\r\n\ty = vert * (miny * (i / dim.y) + maxy * ((dim.y - i) / dim.y)) + (1 - vert) * norm.y;\r\n\t\r\n\tif (coord < 0 && sample(in1, vec(x, y)).x != 0) {\r\n\t\tcoord = i;\r\n\t}\r\n\t\r\n\ti = i + 1;\r\n}\r\n\r\nout1 = coord;",
													"fontface" : 0,
													"fontname" : "Arial",
													"fontsize" : 12.0,
													"id" : "obj-5",
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 20.0, 54.0, 621.0, 318.0 ],
													"style" : ""
												}
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 20.0, 388.0, 37.0, 22.0 ],
													"style" : "",
													"text" : "out 1"
												}
...
,
									"patching_rect" : [ 229.0, 112.0, 112.0, 22.0 ],
									"style" : "",
									"text" : "jit.gl.pix @t bounds"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 367.5, 338.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "zl ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 367.5, 299.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "zl sort"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 252.5, 338.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "zl ecils 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 252.5, 299.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "zl sort"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 137.5, 338.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 137.5, 299.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "zl sort"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 22.5, 338.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "zl slice 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 22.5, 299.0, 43.0, 22.0 ],
									"style" : "",
									"text" : "zl sort"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 410.25, 377.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "Bottom"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 295.25, 377.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "Right"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 180.25, 377.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "Top"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 67.5, 377.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "Left"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 497.5, 411.0, 134.0, 22.0 ],
									"style" : "",
									"text" : "join 2"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 654.875, 372.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "Y"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 540.25, 372.0, 55.25, 20.0 ],
									"style" : "",
									"text" : "X"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 612.5, 372.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 120."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 497.5, 372.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 160."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 671.5, 299.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "zl len"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 612.5, 299.0, 45.0, 22.0 ],
									"style" : "",
									"text" : "zl sum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 612.5, 260.0, 98.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 497.5, 338.0, 29.5, 22.0 ],
									"style" : "",
									"text" : "/ 1."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 556.5, 299.0, 39.0, 22.0 ],
									"style" : "",
									"text" : "zl len"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 497.5, 299.0, 45.0, 22.0 ],
									"style" : "",
									"text" : "zl sum"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 497.5, 260.0, 98.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 497.5, 221.0, 118.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 22.5, 260.0, 98.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 367.5, 260.0, 98.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 252.5, 260.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "jit.spill @plane 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 137.5, 260.0, 98.0, 22.0 ],
									"style" : "",
									"text" : "jit.spill @plane 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 22.5, 143.0, 139.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 22.5, 182.0, 223.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 22.5, 221.0, 108.0, 22.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 12.0, 104.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "jit.unpack"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 54.5, 454.0, 63.0, 33.0 ],
									"style" : "",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 529.5, 457.0, 92.0, 20.0 ],
									"style" : "",
									"text" : "Center of mass"
								}
...
, 							{
								"box" : 								{
									"comment" : "bounding rectangle (list: x1 y1 x2 y2)",
									"id" : "obj-8",
									"index" : 1,
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.5, 455.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 42.5, 23.0, 251.0, 20.0 ],
									"style" : "",
									"text" : "jit_gl_texture input: black and white obstacles"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 12.0, 65.0, 137.0, 22.0 ],
									"style" : "",
									"text" : "jit.matrix @dim 160 120"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 367.5, 377.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 120."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 137.5, 377.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 120."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 252.5, 377.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 160."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 22.5, 377.0, 41.0, 22.0 ],
									"style" : "",
									"text" : "/ 160."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.5, 416.0, 364.0, 22.0 ],
									"style" : "",
									"text" : "join 4"
								}
...
, 							{
								"box" : 								{
									"comment" : "center of mass of occupied pixels (list: x y)",
									"id" : "obj-15",
									"index" : 2,
									"maxclass" : "outlet",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 497.5, 450.0, 30.0, 30.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									"comment" : "4 plane char video in / messages in",
									"id" : "obj-1",
									"index" : 1,
									"maxclass" : "inlet",
									"numinlets" : 0,
...
,
					"patching_rect" : [ 77.0, 230.0, 113.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 55.0, 98.0, 22.0 ],
					"style" : "",
					"text_width" : 60.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 606.277771, 131.0, 80.0, 35.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 12.0, 55.0, 22.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 12.0, 120.0, 149.0, 22.0 ],
					"style" : "",
					"text" : "jit.world motion @visible 0"
				}
